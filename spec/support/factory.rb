    ...
    def payload
      {
        "order" => {
            ...
            "currency" => "USD",
            "placed_on" => "2013-07-30T19:19:05.000Z",
            "updated_at" => "2013-07-30T20:08:39.000Z",
            "status" => "complete",
            "totals" => {
                "item" => 99.95,
                "adjustment" => 15,
            ...
            "shipments" => [
                {
                    ...
                    "tracking" => "null",
                    "updated_at" => "null",
                    "shipped_at" => "2013-07-30T20:08:38.000Z",
                    "items" => [
                        {
                            "name" => "Spree Baseball Jersey",
                            "sku" => "SPR-00001",
        ...
        "original" => {
            ...
            "user_id" => 1,
            "created_at" => "2013-07-29T17:42:02.000Z",
            "updated_at" => "2013-07-30T20:08:39.000Z",
            "completed_at" => "2013-07-30T19:19:05.000Z",
    ...
    def email
      {
        :email => {
          ...
          :variables => {
            ...
            'Ship_To_Address' => '7735 Old Georgetown Rd, Bethesda, Maryland, US, 20814',
            'Bill_To_Address' => '7735 Old Georgetown Rd, Bethesda, Maryland, US, 20814'
          }
        }
      }
    end
